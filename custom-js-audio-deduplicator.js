// Custom JS Function: Audio English Deduplicator
// Paste this code into a "Custom JS Function" block in Tdarr Flow
// This block removes duplicate English audio streams while preserving other languages
// Output 1: Success - continue to next block
// Output 2: Skip - no processing needed
// Output 3: Error - route to error handling
  ...
  try {
    ...
    if (processingResult && processingResult.success && fs.existsSync(processingResult.outputFile)) {
      ...
      return {
        ...
        outputNumber: 1, // Success - continue to next block
