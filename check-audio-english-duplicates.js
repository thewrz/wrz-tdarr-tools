// Check for duplicate English audio streams
// Routes files based on whether they have multiple English audio tracks
// Output 1: Multiple English streams found (needs processing)
// Output 2: Single/no English streams (skip processing)
// Output 3: Undefined language streams present (skip for safety)
...
module.exports = async (args) => {
  try {
    ...
    // Store analysis in flow variables for potential use by downstream plugins
